...
"QPushButton:pressed{color: white; background-color: rgb(25,25,25); border-radius:25px;border-color: rgb(25,25,25);border-width: 1px;border-style: solid;}")
        ...
        self.label_5 = QtWidgets.QLabel(self.securityPage)
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.admin_qrcode_2 = QtWidgets.QLabel(self.securityPage)
        ...
        self.verticalLayout_26.addWidget(self.admin_qrcode_2)
