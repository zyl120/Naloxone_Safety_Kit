...
class Ui_activeHoursPicker(object):
    def setupUi(self, activeHoursPicker):
        ...
        self.startTimeHour.setProperty("value", 8)
        ...
        self.endTimeHour.setProperty("value", 6)
        ...
        self.endTimeAPM.setCurrentIndex(1)
    ...
    def retranslateUi(self, activeHoursPicker):
        ...
        self.endTimeAPM.setCurrentText(_translate("activeHoursPicker", "PM"))
